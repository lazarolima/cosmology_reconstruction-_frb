...
class DM_EXT_model:
    ...
    def I(self, z, Omega_bh2, H0, Omega_m, f_IGM, param, model_type, cosmo_type, omega_0, omega_a, param_type):
        ...
        return self.xe_fid * fIGM * self.factor * Omega_bh2 * (1 + z) / (H0 * H_th)
    

    def DM_IGM(self, z, Omega_bh2, H0, Omega_m, f_IGM, param, model_type, cosmo_type, omega_0, omega_a, param_type):

        integrand = lambda z: self.I(z, Omega_bh2, H0, Omega_m, f_IGM, param, model_type, cosmo_type, omega_0, omega_a, param_type)
    ...
    def DM_ext_th(self, z, f_IGM, H0, DM_host_0, model_type, cosmo_type, param_type, omega_0=None, omega_a=None, Omega_bh2=None, Omega_m=None, param=None):
        ...
        dm_igm_th = self.DM_IGM(z, Omega_bh2, H0, Omega_m, f_IGM, param, model_type, cosmo_type, omega_0, omega_a, param_type)
